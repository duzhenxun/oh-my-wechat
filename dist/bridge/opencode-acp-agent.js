...
export class OpenCodeAcpAgent {
    ...
    request(method, params) {
        ...
        return new Promise((resolve, reject) => {
            this.pending.set(String(id), { resolve: (value) => resolve(value), reject });
            try {
...
function asSessionNotification(value) {
    return isRecord(value) ? value : {};
}
function asRequestPermission(value) {
    return isRecord(value) ? value : {};
}
function extractTextChunk(update) {
...
function choosePermissionOption(options, yes) {
...
function buildApprovalTicket(request, requestId) {
...
//# sourceMappingURL=opencode-acp-agent.js.map