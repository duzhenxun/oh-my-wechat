...
export class ClaudePrintAgent {
    ...
    async continueAfterApproval(pending, approved, toolNames) {
        try {
    ...
    handleClaudeResult({ parsed, stderr }, prompt, fromApprovalDecision) {
...
function buildApprovalTicket(denials) {
...
function approvalTarget(denial) {
...
function uniqueToolNames(denials) {
    return [...new Set(denials
...
//# sourceMappingURL=claude-print-agent.js.map